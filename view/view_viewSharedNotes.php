...
<html>
    <head>
        <title>My notes - Shared by --</title>
    ...
    <body data-bs-theme="dark">
        <div class="container-fluid d-flex flex-column">
            ...
            <div class="d-flex justify-content-between mt-2">
                ...
                <h1 class="fs-4 d-flex me-3">Shared by --</h1>
            </div>
            <!-- CARDS -->
            <h2 class="h2 fs-6 mt-4 ms-2">Notes shared to you by -- as editor</h2>
            ...
            <h2 class="h2 fs-6 mt-1 ms-2">Notes shared to you by -- as reader</h2>
            <div class="d-flex flex-row flex-wrap justify-content-start">
                <div class="card m-1" style="max-width: 48%;" data-bs-theme="dark">
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item">Titre</li>
