    ...
    <body data-bs-theme="dark">
        <form class="container-fluid d-flex flex-column" action="addTextNote" method="post" oninput='checkAll();'>
            ...
            <div class="mt-3">
                ...
                <textarea id="content" name="content" type="text" style="height:600px" placeholder="Write something here" class="form-control" value="<?= $content ?>" oninput="checkContent();"></textarea>
            </div>
        </form>
