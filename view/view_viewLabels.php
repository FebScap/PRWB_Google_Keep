    ...
    <div class="container-fluid d-flex flex-column"> 
                ...
                <?php for ($i=0; $i<count($labelList); $i++) : ?>
                    <div>
                        <div class='input-group flex-nowrap mt-2'>
                            <label id='checklist' name='label[<?= $i ?>]' type='text' class='form-control' value='<?= $labelList[$i]->getContent() ?>' placeholder='Item title' aria-describedby='basic-addon1'>
            ...
            <div id="newItemDiv">
                <form class='input-group flex-nowrap mt-2' method='post' action='OpenNote/addItem' id='formaddlabel'>
                    <input id='addlabel' form='formaddlabel' type='text' class='form-control' placeholder='Type to search or create' aria-describedby='basic-addon1'>  
